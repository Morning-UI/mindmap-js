...
function () {
    function CustomGroup(graph) {
        ...
        this.styles = (0, _deepMix.default)({}, CustomGroup.getDefaultCfg(), groupStyle); // 创建的群组集合
        this.customGroup = {};
    ...
    CustomGroup.prototype.create = function (groupId, nodes, type, zIndex, updateDataModel, title) {
        ...
        var _a = this.calculationGroupPosition(nodes), x = _a.x, y = _a.y, width = _a.width, height = _a.height, maxX = _a.maxX;
        ...
        if (type === 'circle') {
            ...
            keyShape = nodeGroup.addShape('circle', {
                attrs: (0, _tslib.__assign)((0, _tslib.__assign)({}, defaultStyle), {
                    x: cx,
                    y: cy,
                    r: lastR
                }),
        ...
        if (groupTitle) {
            var _b = groupTitle.offsetX, offsetX = _b === void 0 ? 0 : _b, _c = groupTitle.offsetY, offsetY = _c === void 0 ? 0 : _c, _d = groupTitle.text, text = _d === void 0 ? groupTitle : _d, titleStyle = (0, _tslib.__rest)(groupTitle, ["offsetX", "offsetY", "text"]);
    ...
    CustomGroup.prototype.setGroupStyle = function (keyShape, style) {
        ...
        var styles = {};
        var _a = this.styles, hoverStyle = _a.hover, defaultStyle = _a.default;
        if ((0, _isString.default)(style)) {
            if (style === 'default') {
                styles = (0, _deepMix.default)({}, defaultStyle);
            }
            else if (style === 'hover') {
                styles = (0, _deepMix.default)({}, hoverStyle);
            }
        }
        else {
            styles = (0, _deepMix.default)({}, defaultStyle, style);
        }
    ...
    CustomGroup.prototype.calculationGroupPosition = function (nodes, position) {
        ...
        nodes.forEach(function (id) {
            var element = (0, _isString.default)(id) ? graph.findById(id) : id;
    ...
    */
    ...
    CustomGroup.prototype.getGroupPadding = function (groupId) {
        ...
        if (currentGroups.length > 0) {
            ...
            (0, _graphic.traverseTree)(treeGroup[0], function (param) {
    ...
    CustomGroup.prototype.setDeletageGroupByStyle = function (groupId, deletage, property) {
        var width = property.width, height = property.height, x = property.x, y = property.y, r = property.r, btnOffset = property.btnOffset;
        ...
        if (!customGroupStyle) {
            ...
            var styles = (0, _deepMix.default)({}, groupStyle, property);
            this.customGroup[groupId] = {
                nodeGroup: deletage,
                groupStyle: styles
            };
    ...
    CustomGroup.prototype.collapseGroup = function (id) {
        ...
        var r = collapse.r, width = collapse.width, height = collapse.height, offsetX = collapse.offsetX, offsetY = collapse.offsetY, otherStyle = (0, _tslib.__rest)(collapse, ["r", "width", "height", "offsetX", "offsetY"]);
    ...
    CustomGroup.prototype.updateEdgeInGroupLinks = function (groupId, sourceOutTargetInEdges, sourceInTargetOutEdges) {
        ...
        this.delegateInGroup[groupId] = (0, _deepMix.default)({
    ...
    CustomGroup.prototype.expandGroup = function (id) {
        ...
        var _a = this.calculationGroupPosition(noCustomNodes), width = _a.width, height = _a.height;
        var nodeGroup = this.getDeletageGroupById(id).nodeGroup;
        var keyShape = nodeGroup.get('keyShape');
        var _b = this.styles, defaultStyle = _b.default, collapse = _b.collapse;
        ...
        if (groupType === 'circle') {
            ...
            var w = collapse.width, h = collapse.height;
            keyShape.animate({
        ...
        if (titleShape) {
            ...
            var _c = groupTitle.offsetX, offsetX = _c === void 0 ? 0 : _c, _d = groupTitle.offsetY, offsetY = _d === void 0 ? 0 : _d;
            if (groupType === 'circle') {
                titleShape.animate({
                    x: keyShape.attr('x') + offsetX,
        ...
        if (delegates) {
            var sourceOutTargetInEdges = delegates.sourceOutTargetInEdges, sourceInTargetOutEdges = delegates.sourceInTargetOutEdges, edgesOuts_1 = delegates.edgesOuts, edgesIn_1 = delegates.edgesIn, delegateNode = delegates.delegateNode; // 恢复source在外的节点
            sourceOutTargetInEdges.map(function (edge) {
    ...
    CustomGroup.prototype.updateGroup = function (groupId, position, originPosition) {
        ...
        if (parentGroupId) {
            ...
            var minX = parentGroupBBox.minX, minY = parentGroupBBox.minY, maxX = parentGroupBBox.maxX, maxY = parentGroupBBox.maxY; // 检查是否拖出了父Group
            ...
            var x = currentKeyShapeBBox.x, y = currentKeyShapeBBox.y;
            if (!(x < maxX && x > minX && y < maxY && y > minY)) {
                ...
                var _a = this.calculationGroupPosition(groupNodes[parentGroupId]), x1 = _a.x, y1 = _a.y, width = _a.width, height = _a.height; // x: x1, y: y1,
    ...
    CustomGroup.prototype.updateItemInGroup = function (groupId, position, originPosition) {
        ...
        otherGroupId.forEach(function (id) {
            ...
            var _a = _this.calculationGroupPosition(noCustomNodes, position), x = _a.x, y = _a.y, width = _a.width, height = _a.height;
            var titleX = 0;
            var titleY = 0;
            if (groupType === 'circle') {
                var cx = (width + 2 * x) / 2;
    ...
    CustomGroup.prototype.dynamicChangeGroupSize = function (evt, currentGroup, keyShape) {
        ...
        if (nodes.length === 0) {
            ...
            var _a = this.calculationGroupPosition(nodes), x = _a.x, y = _a.y, width = _a.width, height = _a.height; // 检测操作的群组中是否包括子群组
            var paddingValue = this.getGroupPadding(groupId);
            var titleX = 0;
            var titleY = 0;
            if (groupType === 'circle') {
