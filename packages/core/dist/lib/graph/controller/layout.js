...
function () {
    ...
    LayoutController.prototype.layout = function (success) {
        ...
        if (this.layoutType !== undefined) {
            try {
                layoutMethod = new _layout.default[this.layoutType](layoutCfg);
            }
            catch (e) {
    ...
    LayoutController.prototype.layoutWithWorker = function (data, success) {
        ...
        var _a = this, layoutCfg = _a.layoutCfg, graph = _a.graph;
    ...
    LayoutController.prototype.handleWorkerMessage = function (event, data, success) {
        var _a = this, graph = _a.graph, workerData = _a.workerData, layoutCfg = _a.layoutCfg;
    ...
    LayoutController.prototype.relayout = function () {
        var _a = this, graph = _a.graph, layoutMethod = _a.layoutMethod;
        this.data = this.setDataFromGraph();
        var nodes = this.data.nodes;
        if (!nodes) {
