...
/** @class */
function (_super) {
    (0, _tslib.__extends)(CircularLayout, _super);
    ...
    CircularLayout.prototype.execute = function () {
        ...
        var degrees = (0, _math.getDegree)(nodes.length, nodeMap, edges);
    ...
    CircularLayout.prototype.topologyOrdering = function (directed) {
        ...
        nodes.forEach(function (node, i) {
            if (i !== 0) {
                if ((i === n - 1 || degrees[i] !== degrees[i + 1] || connect(orderedNodes[k], node, edges)) && pickFlags[i] !== true) {
                    ...
                    for (var j = 0; j < children.length; j++) {
                        var childIdx = nodeMap[children[j].id];
