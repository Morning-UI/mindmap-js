...
var _default = {
    ...
    updateDelegate: function updateDelegate(evt) {
        ...
        if (!delegateShape) {
            ...
            var bboxX = groupBbox.x, bboxY = groupBbox.y, width = groupBbox.width, height = groupBbox.height;
            var attrs = (0, _tslib.__assign)({
                width: width,
                height: height
            }, (0, _deepMix.default)({}, _global.default.delegateStyle, this.delegateStyle)); // 如果delegate是circle
            ...
            var _a = this, mouseOrigin = _a.mouseOrigin, shapeOrigin = _a.shapeOrigin;
