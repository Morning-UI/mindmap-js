...
var singleEdgeDef = Object.assign({}, _shapeBase.shapeBase, singleEdge);
...
_shape.default.registerEdge('arc', {
    ...
    getControlPoints: function getControlPoints(cfg) {
        ...
        if (cfg.controlPoints !== undefined) {
            ...
            if ((0, _isArray.default)(cfg.curveOffset)) {
...
_shape.default.registerEdge('quadratic', {
    ...
    getControlPoints: function getControlPoints(cfg) {
        ...
        if (!controlPoints || !controlPoints.length) {
            ...
            if ((0, _isArray.default)(this.curveOffset))
                cfg.curveOffset = cfg.curveOffset[0];
            if ((0, _isArray.default)(this.curvePosition))
...
_shape.default.registerEdge('cubic', {
    ...
    getControlPoints: function getControlPoints(cfg) {
        ...
        if (cfg.curvePosition === undefined)
            cfg.curvePosition = this.curvePosition;
        if ((0, _isNumber.default)(cfg.curveOffset))
            cfg.curveOffset = [cfg.curveOffset, -cfg.curveOffset];
        if ((0, _isNumber.default)(cfg.curvePosition))
...
_shape.default.registerEdge('cubic-vertical', {
    ...
    getControlPoints: function getControlPoints(cfg) {
        ...
        if ((0, _isNumber.default)(this.curvePosition))
