...
var singleNode = {
    ...
    getSize: function getSize(cfg) {
        var size = cfg.size || this.options.size || _global.default.defaultNode.size; // size 是数组，但长度为1，则补长度为2
    ...
    updateIcon: function updateIcon(cfg, item) {
        ...
        if (iconShape) {
            ...
            if (show || show === undefined) {
                ...
                var iconConfig = (0, _util.mix)({}, defaultIcon, iconShape.attr(), cfg.icon);
...
var singleNodeDef = Object.assign({}, _shapeBase.shapeBase, singleNode);
