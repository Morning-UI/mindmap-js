...
var shapeBase = {
    ...
    drawLabel: function drawLabel(cfg, group) {
        ...
        if (rotate) {
            ...
            if (!labelMatrix) {
                labelMatrix = _matrixUtil.mat3.create();
            }
        ...
        if (cfg.label || cfg.label === '') {
            ...
            if (!label) {
                ...
                if (rotate) {
                    ...
                    var rotateMatrix = _matrixUtil.mat3.create();
    ...
    setState: function setState(name, value, item) {
        ...
        if (value) {
            ...
            // 所有生效的 state 的样式
            var enableStatesStyle = (0, _util.clone)(item.getCurrentStatesStyle()); // 原始样式
            var originStyle = (0, _util.clone)(item.getOriginStyle());
            ...
            var _loop_3 = function _loop_3(p) {
                ...
                if ((0, _util.isPlainObject)(style)) {
                    ...
                    if (subShape) {
                        ...
                        (0, _util.each)(style, function (value, key) {
            ...
            // 否则为普通对象
            if (!keyShapeName) {
                (0, _util.mix)(filtetDisableStatesStyle, keyShapeStyles);
            }
            else {
            ...
            for (var key in enableStatesStyle) {
                ...
                if (!(0, _util.isPlainObject)(enableStyle)) {
                    // 把样式属性merge到keyShape中
                    if (!keyShapeName) {
                        (0, _util.mix)(originStyle, (_a = {}, _a[key] = enableStyle, _a));
                    }
                    else {
                        (0, _util.mix)(originStyle[keyShapeName], (_b = {}, _b[key] = enableStyle, _b));
                    }
                    delete enableStatesStyle[key];
                }
            }
            var originstyles = {};
            (0, _util.deepMix)(originstyles, originStyle, filtetDisableStatesStyle, enableStatesStyle);
    ...
    getStateStyle: function getStateStyle(name, value, item) {
        ...
        if (value) {
            ...
            return (0, _util.mix)({}, model.style, modelStateStyle);
        }
        return {};
    },
    /**
