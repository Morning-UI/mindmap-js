...
_shape.default.registerNode('modelRect', {
    ...
    drawShape: function drawShape(cfg, group) {
        ...
        var preRectShow = preRect.show, preRectStyle = (0, _tslib.__rest)(preRect, ["show"]);
        if (preRectShow) {
            group.addShape('rect', {
    ...
    drawLogoIcon: function drawLogoIcon(cfg, group) {
        ...
        var width = size[0];
        if (logoIcon.show) {
            var w = logoIcon.width, h = logoIcon.height, x = logoIcon.x, y = logoIcon.y, offset = logoIcon.offset, logoIconStyle = (0, _tslib.__rest)(logoIcon, ["width", "height", "x", "y", "offset"]);
    ...
    drawStateIcon: function drawStateIcon(cfg, group) {
        ...
        var width = size[0];
        if (stateIcon.show) {
            var w = stateIcon.width, h = stateIcon.height, x = stateIcon.x, y = stateIcon.y, offset = stateIcon.offset, iconStyle = (0, _tslib.__rest)(stateIcon, ["width", "height", "x", "y", "offset"]);
    ...
    drawLabel: function drawLabel(cfg, group) {
        var _a = this.options, defaultLabelCfg = _a.labelCfg, defaultLogoIcon = _a.logoIcon, defaultDescritionCfg = _a.descriptionCfg;
        var logoIcon = (0, _util.mix)({}, defaultLogoIcon, cfg.logoIcon);
    ...
    update: function update(cfg, item) {
        var _a = this.options, defaultStyle = _a.style, defaultLabelCfg = _a.labelCfg, defaultDescritionCfg = _a.descriptionCfg;
        ...
        if (logoIconShape) {
            if (!show && show !== undefined) {
                ...
                var logoW = logoIcon.width, h = logoIcon.height, x = logoIcon.x, y = logoIcon.y, logoOffset = logoIcon.offset, logoIconStyle = (0, _tslib.__rest)(logoIcon, ["width", "height", "x", "y", "offset"]);
        ...
        if (stateIconShape) {
            ...
            var stateW = stateIcon.width, h = stateIcon.height, x = stateIcon.x, y = stateIcon.y, stateOffset = stateIcon.offset, stateIconStyle = (0, _tslib.__rest)(stateIcon, ["width", "height", "x", "y", "offset"]);
