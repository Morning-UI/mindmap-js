...
_shape.default.registerNode('star', {
    ...
    drawLinkPoints: function drawLinkPoints(cfg, group) {
        ...
        var top = linkPoints.top, left = linkPoints.left, right = linkPoints.right, leftBottom = linkPoints.leftBottom, rightBottom = linkPoints.rightBottom, markSize = linkPoints.size, markStyle = (0, _tslib.__rest)(linkPoints, ["top", "left", "right", "leftBottom", "rightBottom", "size"]);
    ...
    updateLinkPoints: function updateLinkPoints(cfg, group) {
        ...
        }, left = _a.left, right = _a.right, top = _a.top, leftBottom = _a.leftBottom, rightBottom = _a.rightBottom;
        var size = this.getSize(cfg);
        var outerR = size[0];
        var styles = {
            r: markSize,
