...
function () {
    ...
    CustomGroup.prototype.create = function (groupId, nodes, type, zIndex, updateDataModel, title) {
        ...
        if (groupTitle) {
            var _b = groupTitle.offsetX, offsetX = _b === void 0 ? 0 : _b, _c = groupTitle.offsetY, offsetY = _c === void 0 ? 0 : _c, _d = groupTitle.text, text = _d === void 0 ? groupTitle : _d, titleStyle = __rest(groupTitle, ["offsetX", "offsetY", "text"]);
    ...
    */
    ...
    CustomGroup.prototype.collapseGroup = function (id) {
        ...
        var r = collapse.r, width = collapse.width, height = collapse.height, offsetX = collapse.offsetX, offsetY = collapse.offsetY, otherStyle = __rest(collapse, ["r", "width", "height", "offsetX", "offsetY"]);
