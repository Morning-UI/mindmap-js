    ...
    update: function update(cfg, item) {
        ...
        if (logoIconShape) {
            if (!show && show !== undefined) {
                ...
                var logoW = logoIcon.width, h = logoIcon.height, x = logoIcon.x, y = logoIcon.y, logoOffset = logoIcon.offset, logoIconStyle = __rest(logoIcon, ["width", "height", "x", "y", "offset"]);
        ...
        if (stateIconShape) {
            ...
            var stateW = stateIcon.width, h = stateIcon.height, x = stateIcon.x, y = stateIcon.y, stateOffset = stateIcon.offset, stateIconStyle = __rest(stateIcon, ["width", "height", "x", "y", "offset"]);
